...
if __name__ == '__main__':
    ...
    eval_acc_cost(threshold_list=[0.4, 0.5, 0.55, 0.6, 0.65, 0.7, 0.8, 0.9, 1],M=M, N=N, data_list=data_list, cot_prompt_list=cot_prompt_list, pot_prompt_list=pot_prompt_list)
