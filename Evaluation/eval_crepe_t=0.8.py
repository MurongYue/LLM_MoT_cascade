...
if __name__ == '__main__':
    M = 3  # example number
    N = 20  # SC number
    data_cot11 = read_json('GPT3_result/crepe_cot1_t=0.8.json')
    data_cot12 = read_json('GPT3_result/crepe_cot1_t=0.8.json')
    data_cot21 = read_json('GPT3_result/crepe_cot2_t=0.8.json')
    data_cot22 = read_json('GPT3_result/crepe_cot2_t=0.8.json')
    data_pot11 = read_json('GPT3_result/crepe_pot1_t=0.8.json')
    data_pot12 = read_json('GPT3_result/crepe_pot1_t=0.8.json')
    data_pot21 = read_json('GPT3_result/crepe_pot2_t=0.8.json')
    data_pot22 = read_json('GPT3_result/crepe_pot2_t=0.8.json')
